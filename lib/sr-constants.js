...
var nameToTable = {};
nameToTable[this.FOOD_DESCRIPTION_TABLE.name] = this.FOOD_DESCRIPTION_TABLE;
nameToTable[this.FOOD_GROUP_DESCRIPTION_TABLE.name] = this.FOOD_GROUP_DESCRIPTION_TABLE;
nameToTable[this.LANGUAL_FACTOR_TABLE.name] = this.LANGUAL_FACTOR_TABLE;
nameToTable[this.LANGUAL_FACTORS_DESCRIPTION_TABLE.name] = this.LANGUAL_FACTORS_DESCRIPTION_TABLE;
nameToTable[this.NUTRIENT_DATA_TABLE.name] = this.NUTRIENT_DATA_TABLE;
nameToTable[this.NUTRIENT_DEFINITION_TABLE.name] = this.NUTRIENT_DEFINITION_TABLE;
nameToTable[this.SOURCE_CODE_TABLE.name] = this.SOURCE_CODE_TABLE;
nameToTable[this.DATA_DERIVATION_CODE_TABLE.name] = this.DATA_DERIVATION_CODE_TABLE;
nameToTable[this.WEIGHT_TABLE.name] = this.WEIGHT_TABLE;
nameToTable[this.FOOTNOTE_TABLE.name] = this.FOOTNOTE_TABLE;
nameToTable[this.SOURCES_OF_DATA_LINK_TABLE.name] = this.SOURCES_OF_DATA_LINK_TABLE;
nameToTable[this.SOURCES_OF_DATA_TABLE.name] = this.SOURCES_OF_DATA_TABL;
define("NAME_TO_TABLE", nameToTable);

define("TOP_LEVEL_TABLES", [
  this.FOOD_DESCRIPTION_TABLE,
  this.LANGUAL_FACTOR_TABLE,
  this.NUTRIENT_DATA_TABLE,
  this.WEIGHT_TABLE,
...
define("KEY_COL", this.FOOD_DESCRIPTION_TABLE.columns[0]);
