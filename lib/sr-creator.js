...
SrCreator.prototype.generate = function(dbPath, esExportPath, mappingsFilePath) {
  this.generateSqliteDb(dbPath, function(srDatabase) {
    console.log('Database \'' + srDatabase.path + '\'ready');
    this.generateEsExport(esExportPath, function() {
    });
  });
};
...
SrCreator.prototype.generateEsExport = functioN(esExportPath, cb) {
